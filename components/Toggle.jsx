...
export class Toggle extends React.Component {
    onClickToggle(props, state) {
        ...
        fetch(props.link,
            ...
            self.OnClickToggle(props, state)
        })
    }
    ...
    Toggle(props, state) {
        return <><label className={'switch'}
                        style={{display: 'inline-block', height: '34px', position: 'relative', width: '60px'}}>
            <input style={{height: 0, opacity: 0, width: 0}} onClick={this.onClickToggle.bind(this, props, state)}
                   type={'checkbox'}/>
