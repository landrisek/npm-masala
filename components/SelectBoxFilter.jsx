...
export class SelectBoxFilter {
    ...
    SelectBoxFilter(props, state) {
        ...
        return <div className={'form-group'}><label>{props.label}</label><select className={'form-control'}
                                                                                 key={props.id}
                                                                                 onChange={this.onChangeSelectBoxFilter.bind(this, props)}>{options}</select>
        </div>
    }
}
